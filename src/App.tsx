...
function Layout({ children }: { children: React.ReactNode }) {
  return (
    ...
    <div className="min-h-screen w-full max-w-full overflow-x-hidden flex flex-col bg-[#0A0A0A] text-gray-200 font-sans pb-16 md:pb-0">
      <Navbar />
      
      <main className="flex-1 w-full max-w-full overflow-x-hidden p-4 sm:p-6 lg:p-8 flex flex-col gap-6">
        {children}
      </main>
